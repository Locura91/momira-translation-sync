...
# even at max_output_tokens=32768. Batches run CONCURRENTLY now (see
# translate_in_batches in translator.py), so more/smaller batches cost
# nothing in wall-clock time — this is pure safety margin, not a speed
# tradeoff.
DATASHEET_BATCH_SIZE = 3
